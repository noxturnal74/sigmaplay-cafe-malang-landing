...
if (!js.includes("requestAnimationFrame") || !js.includes('motionProfile = "gaming"') || !html.includes('data-motion-profile="gaming"')) {
...
console.log("Sigmaplay & Cafe brand-DNA build check passed.");
